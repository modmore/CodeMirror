...
$_lang['prop_cm.autoClearEmptyLines_desc'] = 'When turned on (default is off), this will clear automatically clear lines consisting only of whitespace when the cursor leaves them. This is mostly useful to prevent auto indentation from introducing trailing whitespace in a file.';
...
$_lang['prop_cm.lineWrapping_desc'] = 'Whether CodeMirror should scroll or wrap for long lines.';
...
$_lang['prop_cm.smartIndent_desc'] = 'Whether to use the context-sensitive indentation (or just indent the same as the line before).';
